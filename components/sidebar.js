        ...
        <div className="-my-4 divide-y-2 divide-gray-100">
          ...
          <div className="py-4">
            <a
              ...
              className="inline-block bg-gray-800 px-4 py-2.5 text-base leading-6 font-semibold transition duration-150 ease-in-out text-white rounded-none focus:shadow-outline focus:outline-none focus:bg-gray-700 hover:bg-gray-700 active:bg-gray-900"
            >
              Apply for this job
            </a>
          </div>
